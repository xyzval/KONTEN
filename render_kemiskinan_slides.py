...
def render_slide_2(bg_path, output_path):
    ...
    font_quote = ImageFont.truetype("/home/user/fonts/Roboto-Bold.ttf", int(h * 0.038))
    font_text = ImageFont.truetype("/home/user/fonts/Roboto-Bold.ttf", int(h * 0.022))
    
    lines = [
        "kemiskinan membuat seorang pria",
        "kehilangan haknya sebagai manusia",
        "ia dipandang seperti lumpur dibawah sepatu",
        "dibutuhkan hanya untuk di'injak."
    ]
...
render_slide_1('/home/user/demon_asking_harsh_truth.jpg', '/home/user/slide1_fakta_menyakitkan.jpg')
render_slide_2('/home/user/pitiful_skeleton_poverty.jpg', '/home/user/slide2_kemiskinan_tengkorak.jpg')
