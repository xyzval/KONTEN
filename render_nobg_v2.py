...
def render_slide2(bg_path, output_path):
    ...
    # Create high-contrast shadow map
    ...
    # Quote mark
    shadow_draw.text((left_x, start_y - int(h * 0.035)), "“", font=font_quote, fill=(0, 0, 0, 255))
    text_draw.text((left_x, start_y - int(h * 0.035)), "“", font=font_quote, fill=(255, 255, 255, 255))
    
    cur_y = start_y
    for line in ar_lines:
        shadow_draw.text((right_x, cur_y), line, font=font_ar, fill=(0, 0, 0, 255), direction='rtl', language='ara', anchor='ra')
        text_draw.text((right_x, cur_y), line, font=font_ar, fill=(255, 255, 255, 255), direction='rtl', language='ara', anchor='ra')
        cur_y += ar_line_h
    ...
    # Create a nice outline / glow shadow
...
render_slide2('/home/user/concept_shrouded_figure.jpg', '/home/user/slide2_tanpa_background_bersih.jpg')
