...
def render_slide1_phil(bg_path, output_path, lines):
    ...
    print(f"Philosophical Slide 1 saved: {output_path}")

# Option A: Moralitas & Tindakan
render_slide1_phil('/home/user/mask_hypocrisy_concept.jpg', '/home/user/slide1_filsafat_moralitas.jpg', [
    "apakah moralitas diukur dari",
    "perkataan atau tindakan ??"
])

# Option B: Terlihat Suci vs Menjadi Baik
render_slide1_phil('/home/user/mask_hypocrisy_concept.jpg', '/home/user/slide1_filsafat_kesucian.jpg', [
    "mengapa manusia lebih sibuk",
    "terlihat suci daripada menjadi baik ??"
])

# Option C: Nilai Kebenaran Tanpa Praktik
render_slide1_phil('/home/user/mask_hypocrisy_concept.jpg', '/home/user/slide1_filsafat_praktik.jpg', [
    "apa nilai sebuah kebenaran",
    "jika tidak pernah dipraktikkan ??"
])
