...
def render_demon_slide2(bg_path, output_path):
    ...
    print(f"Slide 2 with Demon saved: {output_path}")

render_demon_slide2('/home/user/demon_pondering_gold.jpg', '/home/user/slide2_iblis_harta.jpg')
