...
def render_slide_1(base_path, output_path):
    img = Image.open(base_path)
    w, h = img.size
    
    # Zoom/Crop left side (Demon) maintaining aspect ratio
    zoom_factor = 0.72
...
def render_slide_2(base_path, output_path):
    img = Image.open(base_path)
    w, h = img.size
    
    # Zoom/Crop right side (Scholar) maintaining aspect ratio
    zoom_factor = 0.72
    crop_w = int(w * zoom_factor)
    crop_h = int(h * zoom_factor)
...
def render_slide_3(base_path, output_path):
    ...
    res.save(output_path, quality=98)
    print(f"Slide 3 saved: {output_path}")

render_slide_1('/home/user/takdir_masterpiece.jpg', '/home/user/slide1_takdir_doa.jpg')
render_slide_2('/home/user/takdir_masterpiece.jpg', '/home/user/slide2_takdir_doa.jpg')
render_slide_3('/home/user/takdir_masterpiece.jpg', '/home/user/slide3_takdir_doa.jpg')
