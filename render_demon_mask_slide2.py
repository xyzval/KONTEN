...
def render_demon_mask_slide2(bg_path, output_path):
    ...
    print(f"Slide 2 with Demon Mask saved: {output_path}")

render_demon_mask_slide2('/home/user/demon_holding_holy_mask.jpg', '/home/user/slide2_iblis_topeng_suci.jpg')
