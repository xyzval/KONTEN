...
def render_ustadz_slide1(base_path, output_path):
    ...
    print(f"Ustadz Slide 1 saved: {output_path}")

def render_ustadz_slide2(base_path, output_path):
    img = Image.open(base_path)
    w, h = img.size
    
    # Proper crop preserving 3:4 aspect ratio focusing on the Ustadz on the right
    zoom_factor = 0.72
    crop_w = int(w * zoom_factor)
    crop_h = int(h * zoom_factor)
    ...
    res.save(output_path, quality=98)
    print(f"Ustadz Slide 2 saved: {output_path}")

def render_ustadz_slide3(base_path, output_path):
    ...
    res.save(output_path, quality=98)
    print(f"Ustadz Slide 3 saved: {output_path}")

render_ustadz_slide1('/home/user/demon_ustadz_dialogue.jpg', '/home/user/slide1_ustadz_takdir.jpg')
render_ustadz_slide2('/home/user/demon_ustadz_dialogue.jpg', '/home/user/slide2_ustadz_takdir.jpg')
render_ustadz_slide3('/home/user/demon_ustadz_dialogue.jpg', '/home/user/slide3_ustadz_takdir.jpg')
