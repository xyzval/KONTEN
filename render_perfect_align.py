...
def render_final(bg_path, output_path, start_y_ratio=0.41, left_ratio=0.07):
    ...
    left_x = int(w * left_ratio)
    start_y = int(h * start_y_ratio)
    
    ar_line_h = int(h * 0.033)
    ...
    # Arabic lines - aligned to left margin (starts at left_x, flows RTL so left edge is at left_x)
    cur_y = start_y
...
render_final('/home/user/concept_shrouded_figure.jpg', '/home/user/slide2_revisi_final.jpg', start_y_ratio=0.40)
